...
function addToy(name, price, description, img, inventory){
	if(bool_1 && bool_2 && bool_3 && bool_4 && bool_5){
	    ...
	    xmlhttp.open("GET","addToyBG.php?name=" + name + "&price=" + price + "&description=" + description + "&img=" + img + "&inventory=" + inventory,true);
	    xmlhttp.send();
